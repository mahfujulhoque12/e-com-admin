...
import img from "/public/product/customer.png"; // ✅ Adjust the path if needed
...
export async function GET() {
  const sanitizedData = orderListData.map((item) => ({
    ...item,
    img: "/product/customer.png", // ✅ convert StaticImageData to serializable string
  }));
