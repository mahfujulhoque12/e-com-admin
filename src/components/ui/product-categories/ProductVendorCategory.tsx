...
import { useGetPVendorCategoryTableQuery } from "@/redux/feature/api/p-category/PVendorApi";
...
const ProductVendorCategory = () => {
  ...
  const key = "productVendorCategory";
  ...
  const { data, isLoading, isError, error } =
    useGetPVendorCategoryTableQuery(currentPage);
  ...
  return (
    <div>
      ...
      <div className="mt-5  mx-5 flex items-center justify-between flex-col md:flex-row">
        ...
        <div>
          <Pagination paginationKey="productVendorCategory" />
        </div>
      </div>
    </div>
  );
