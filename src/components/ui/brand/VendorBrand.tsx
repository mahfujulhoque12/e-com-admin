...
import { useGetVendorBrandQuery } from "@/redux/feature/api/brand/VendorBrandApi";
...
const VendorBrand = () => {
  ...
  const { data, isLoading, isError, error } =
    useGetVendorBrandQuery(currentPage);
  ...
  return (
    <div>
      <div className="mt-5 bg-primary p-5 rounded-md shadow-md">
        <h2 className="text-color text-xl font-semibold">Brand List</h2>
      ...
      <div className="mt-5 mx-5 flex items-center justify-between flex-col md:flex-row">
        ...
        <div>
          <Pagination paginationKey="vendorBrand" />
        </div>
      </div>
    </div>
  );
