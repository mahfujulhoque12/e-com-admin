  ...
  return (
    <div>
      ...
      <div className="flex items-baseline flex-col sm:flex-row justify-between gap-3">
        <p className="text-gray-600 font-semibold text-2xl ">Folders</p>
      ...
      {/* table start */}
      <div className="w-full overflow-x-auto p-5 border border-gray-200 mt-5 shadow-md rounded-md ">
        <h3 className="pb-5 font-semibold text-lg text-gray-600">
          Recent Files
        </h3>
            ...
            <tbody className="bg-white">
              {fileListData.map((product) => (
                ...
                >
                  ...
                  <td className="px-6 w-full flex py-4 whitespace-nowrap font-medium text-sm text-[#455468]">
